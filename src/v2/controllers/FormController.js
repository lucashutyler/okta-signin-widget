...
export default Controller.extend({
  ...
  postRender() {
    ...
    // // If last action contains remediation with errors, then widget needs to render those errors after state change.
    // // `formError` flag should be set by idx.js ??
    // if(this.options.appState.get('idx')?.formError) {
    //   this.showFormErrors(this, this.options.appState.get('idx'));
    // }
  ...
  handleFormNameChange(controller) {
    // todo : improve this
    // if(controller) {
    //   controller.render();
    // } else {
